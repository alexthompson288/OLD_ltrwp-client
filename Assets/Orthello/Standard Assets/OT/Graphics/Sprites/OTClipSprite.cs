...
/// <summary>
/// A sprite that can be clipped by a local rect
/// </summary>
/// <remarks>
/// The sprite uses a local clipRect (0,0,1,1) to determine the sprites's clip area. A clipFactor (0,1) is used to
/// grow from 0 to the clipRect.
/// </remarks>
