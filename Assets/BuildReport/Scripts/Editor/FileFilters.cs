...
public class FileFilterGroup
{
	...
	{
		BuildReportOptions.FileFilterDisplay displayType = BuildReportOptions.GetOptionFileFilterDisplay();
		switch (displayType)
		{
			case BuildReportOptions.FileFilterDisplay.DropDown:
				DrawFiltersAsDropDown(assetList, width);
				break;
			case BuildReportOptions.FileFilterDisplay.Buttons:
