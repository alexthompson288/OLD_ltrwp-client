...
public partial class BuildReportWindow : EditorWindow
{
	...
	const string BUILD_REPORT_TOOL_DEFAULT_PATH = "Assets/BuildReport";
	const string BUILD_REPORT_TOOL_DEFAULT_FOLDER_NAME = "BuildReport";

	const string DEFAULT_GUI_SKIN_FILENAME = "BuildReportWindow.guiskin";
	const string DARK_GUI_SKIN_FILENAME = "BuildReportWindowDark.guiskin";
