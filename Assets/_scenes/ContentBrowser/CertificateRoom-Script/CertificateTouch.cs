...
public class CertificateTouch : MonoBehaviour {
	
	public Transform colourShield;
	public Transform colourText;
	public Transform Mnemonic;
	public AudioClip MyAudio;
	CertificateRoomManager gameManager;
	float timer=4.0f;
	bool countdown=false;
	
	// Use this for initialization
	void Start () {
		gameManager=GameObject.Find ("Main Camera").GetComponent<CertificateRoomManager>();
	}
